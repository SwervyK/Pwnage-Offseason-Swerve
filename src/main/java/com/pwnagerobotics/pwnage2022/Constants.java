...
public class Constants {
    ...
    public static final double kPoleSnappingAngle = 5; // +- deg
    public static final double kPoleSnappingThreshold = 0.5; // mag > threshold

    // Drivetrain
    public static final double kDriveWidth = 26.125; // 26 1/8 inch //Width between center of drive modules, inches 
    public static final double kDriveLength = 23.375; // 23 3/8 inch //Width between center of drive modules, inches
    public static final double kDriveHypot = Math.hypot(kDriveWidth, kDriveLength);
    ...
    public static final double kDrive180Speed = 3000; // TUNE
