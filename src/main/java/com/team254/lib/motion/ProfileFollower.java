...
public class ProfileFollower {
    ...
    public synchronized double update(MotionState latest_state, double t) {
        ...
        //SmartDashboard.putNumber("Path Pos Nominal", mLatestSetpoint.motion_state.pos());
        //SmartDashboard.putNumber("Path Pos Measured", latest_state.pos());
        //SmartDashboard.putNumber("Path Pos Error", mLatestPosError);
        //SmartDashboard.putNumber("Path Vel Nominal", mLatestSetpoint.motion_state.vel());
        //SmartDashboard.putNumber("Path Vel Measured", latest_state.vel());
        //SmartDashboard.putNumber("Path Vel Error", mLatestVelError);
