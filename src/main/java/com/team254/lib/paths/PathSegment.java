...
public class PathSegment {
    ...
    public PathSegment(double x1, double y1, double x2, double y2, double maxSpeed, MotionState startState,
                       double endSpeed, double maxAccel) {
        ...
        isLine = true;
        createMotionProfiler(startState, endSpeed, maxAccel);
    }

    public PathSegment(double x1, double y1, double x2, double y2, double maxSpeed, MotionState startState,
                       double endSpeed, double maxAccel, String marker) {
        this.start = new Translation2d(x1, y1);
        this.end = new Translation2d(x2, y2);
    ...
    public PathSegment(double x1, double y1, double x2, double y2, double cx, double cy, double maxSpeed,
                       MotionState startState, double endSpeed, double maxAccel) {
        this.start = new Translation2d(x1, y1);
        this.end = new Translation2d(x2, y2);
    ...
    public PathSegment(double x1, double y1, double x2, double y2, double cx, double cy, double maxSpeed,
                       MotionState startState, double endSpeed, double maxAccel, String marker) {
        this.start = new Translation2d(x1, y1);
        this.end = new Translation2d(x2, y2);
        this.center = new Translation2d(cx, cy);
    ...
    public void createMotionProfiler(MotionState start_state, double end_speed, double max_accel) {
        MotionProfileConstraints motionConstraints = new MotionProfileConstraints(maxSpeed, max_accel);
