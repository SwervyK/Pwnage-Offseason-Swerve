...
public class PathFollower {
    ...
    public synchronized Twist2d update(double t, Pose2d pose, double displacement, double velocity) {
        ...
        // SmartDashboard.putNumber("Path Follower/t", mDebugOutput.t);
        // SmartDashboard.putNumber("Path Follower/Pose X", mDebugOutput.pose_x);
        // SmartDashboard.putNumber("Path Follower/Pose Y", mDebugOutput.pose_y);
        // SmartDashboard.putNumber("Path Follower/Pose R", mDebugOutput.pose_theta);
        // SmartDashboard.putNumber("Path Follower/Linear Displacement", mDebugOutput.linear_displacement);
        // SmartDashboard.putNumber("Path Follower/Linear Velocity", mDebugOutput.linear_velocity);
        // SmartDashboard.putNumber("Path Follower/Profile Displacement", mDebugOutput.profile_displacement);
        // SmartDashboard.putNumber("Path Follower/Profile Velocity", mDebugOutput.profile_velocity);
        // SmartDashboard.putNumber("Path Follower/Velocity Command X", mDebugOutput.velocity_command_dx);
        // SmartDashboard.putNumber("Path Follower/Velocity Command Y", mDebugOutput.velocity_command_dy);
        // SmartDashboard.putNumber("Path Follower/Velocity Command R", mDebugOutput.velocity_command_dtheta);
        SmartDashboard.putBoolean("Steering Controller Done", mSteeringController.isFinished());
        SmartDashboard.putBoolean("Velocity Controller Done", mVelocityController.isFinishedProfile());
        SmartDashboard.putBoolean("Velocity Controller On Target", mVelocityController.onTarget());
